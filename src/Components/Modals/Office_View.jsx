...
export default function Office_View({ id, name, salary, Number, Salary_Information , rentAmount, officeAddress, officeArea }) {
...
<h1   className="text-lg p-2">Rent Amount : {rentAmount}</h1>
<h1 className="text-lg p-2" >Office Address :  {officeAddress}</h1>
<h1 className="text-lg p-2" > Office Area  :  {officeArea}</h1>
