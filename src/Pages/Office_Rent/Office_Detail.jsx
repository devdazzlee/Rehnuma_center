...
const Office_List = () => {
  ...
  const getAllProducts = async () => {
    try {
      const response = await axios.get(`http://localhost:8000/api/v1/Office-Rent`);
  ...
  const deleteData = async (id)=>{
    try {
      const response = await axios.delete(`http://localhost:8000/api/v1/customer5/${id}`)
...
const formatProjectId = (projectId) => {
  ...
  <>
     <div className='flex ' >
     <h1 className="text-4xl text-center  mb-6 m-auto">Office  List </h1>
...
<th scope="row" class="px-6 py-4 font-medium text-black whitespace-nowrap dark:text-white">
 ...
 scope="row" class="px-6 py-4 font-medium text-black whitespace-nowrap dark:text-white">
                ...
                <td class=" mr-8 text-right">
                    <Office_View    rentAmount={value.rentAmount}  officeAddress={value.officeAddress}   officeArea={value.officeArea}   id={value._id}    />
                </td>
                <td class=" mr-8 text-right">
                    <Office_Edit    rentAmount={value.rentAmount}  officeAddress={value.officeAddress}   officeArea={value.officeArea}   id={value._id}     />
                </td>
