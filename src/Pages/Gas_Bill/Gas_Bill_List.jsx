...
const Gas_List = () => {
  ...
  const getAllProducts = async () => {
    try {
      const response = await axios.get(`http://localhost:8000/api/v1/Gas-Bill`);
  ...
  const deleteData = async (id)=>{
    try {
      const response = await axios.delete(`http://localhost:8000/api/v1/customer10/${id}`)
...
const formatProjectId = (projectId) => {
  ...
  <>
     <div className='flex ' >
     <h1 className="text-4xl text-center  mb-6 m-auto">Gas Bill List </h1>
