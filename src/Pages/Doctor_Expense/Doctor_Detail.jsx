...
const Doctor_List = () => {
  ...
  const deleteData = async (id)=>{
    try {
      const response = await axios.delete(`http://localhost:8000/api/v1/customer2/${id}`)
...
const formatProjectId = (projectId) => {
  ...
  <>
     <div className='flex ' >
     <h1 className="text-4xl text-center  mb-6 m-auto">Doctor  Details </h1>
...
<th scope="row" class="px-6 py-4 font-medium text-black whitespace-nowrap dark:text-white">
 ...
 scope="row" class="px-6 py-4 font-medium text-black whitespace-nowrap dark:text-white">
                ...
                <td class=" mr-8 text-right">
                    <Modal4    name={value.name} salary={value.salary}  Number={value.number}  Salary_Information={value.address}  id={value._id}    />
                </td>
                <td class=" mr-8 text-right">
                    <Modal3     name={value.name} salary={value.salary}  Number={value.number}  Salary_Information={value.address} id={value._id}    />
                </td>
