...
const formatProjectId = (projectId) => {
  ...
  <>
     <div className='flex ' >
     <h1 className="text-4xl text-center  mb-6 m-auto">Patient Details </h1>
 ...
 scope="row" class="px-6 py-4 font-medium text-black whitespace-nowrap dark:text-white">
    ...
    : 'N/A'}
                ...
                <td class=" mr-8 text-right">
                    <Modal2    name={value.patientName}  age={value.patientAge}  admissionDate={value.AdmissionDate}   admissionFee={value.AdmissionFee} monthlyFee={value.MonthlyFee}  requiredAmount={value.RequiredAmount}  patientDec={value.PatientDescription}   id={value._id}    />
                </td>
                <td class=" mr-8 text-right">
                    <Modal1    name={value.patientName}  age={value.patientAge}  admissionDate={value.AdmissionDate}   admissionFee={value.AdmissionFee} monthlyFee={value.MonthlyFee}  requiredAmount={value.RequiredAmount}  patientDec={value.PatientDescription}   id={value._id}    />
                </td>
