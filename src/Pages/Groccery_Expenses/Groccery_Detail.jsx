...
import Groccery_View from '../../Components/Modals/Groccery_View';
import Groccery_Edit from '../../Components/Modals/Groccery_Edit';
...
const Groccery_List = () => {
  ...
  const getAllProducts = async () => {
    try {
      const response = await axios.get(`http://localhost:8000/api/v1/Groccery`);
  ...
  const deleteData = async (id)=>{
    try {
      const response = await axios.delete(`http://localhost:8000/api/v1/customer4/${id}`)
...
const formatProjectId = (projectId) => {
  ...
  <>
     <div className='flex ' >
     <h1 className="text-4xl text-center  mb-6 m-auto"> Grocery Details </h1>
...
<th scope="row" class="px-6 py-4 font-medium text-black whitespace-nowrap dark:text-white">
 ...
 scope="row" class="px-6 py-4 font-medium text-black whitespace-nowrap dark:text-white">
        ...
        <>
            ...
            {/* Display "...." after the first 12 characters */}
            ....
        </>
    ) : (
        ...
        value.items
                ...
                <td class=" mr-8 text-right">
                    <Groccery_View  totalAmount={value.totalAmount}    date={value.date}     items={value.items}      />
                </td>
                <td class=" mr-8 text-right">
                    <Groccery_Edit     totalAmount={value.totalAmount}    date={value.date}     items={value.items}   id={value._id}    />
                </td>
